...
export const Header = () => {
  ...
  return (
    <header className="fixed w-full top-0 left-0 bg-white z-50">
      <div className="px-[8%] h-20 border-b-2">
        <div className="flex justify-between items-center h-full">
          ...
          shadow-[3px_3px_0] shadow-black font-bold hover:-translate-x-px hover:-translate-y-px cursor-pointer transition-transform duration-300"
          >
            Подать заявку
