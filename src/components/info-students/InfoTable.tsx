  ...
  return (
    <div className="flex flex-col gap-10 bg-white p-12 border-2 rounded-4xl shadow-[10px_10px_0] shadow-black">
      <div className="flex flex-col gap-3">
        <h3 className="text-3xl tracking-tight font-bold">Требования к кандидату</h3>
      ...
      <div className="flex flex-col border-t-2">
        {REQUIREMENTS.map((item, idx) => (
          <div className="flex gap-6 justify-between py-6 items-center border-b last:border-0">
            ...
            <div className="text-primary font-light uppercase text-[10px] tracking-widest whitespace-nowrap">{item.require}</div>
          </div>
        ))}
      </div>
      <div>
